  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/matches" element={<AppLayout><ComingSoon title="Matches" /></AppLayout>} />
        <Route path="/chat" element={<AppLayout><ComingSoon title="Chat" /></AppLayout>} />
        <Route path="/sessions/new" element={<AppLayout><ComingSoon title="Schedule a session" /></AppLayout>} />
        <Route path="/calendar" element={<AppLayout><ComingSoon title="Calendar" /></AppLayout>} />
