...
import ReviewsAchievementsPage from '@/pages/ReviewsAchievementsPage'
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/skills/:id" element={<AppLayout><SkillDetailsPage /></AppLayout>} />
        ...
        <Route path="/reviews" element={<AppLayout><ReviewsAchievementsPage /></AppLayout>} />
        <Route path="/achievements" element={<AppLayout><ReviewsAchievementsPage /></AppLayout>} />
